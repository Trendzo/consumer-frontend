...
const sampleProducts = [
  {
    ...
    description: 'Step out in style with our Red Sneakers, crafted for comfort and impact. Perfect for daily wear or a casual outing. These ain\'t just shoes - they\'re a vibe ✨',
    rating: 4.8,
    reviews: 324,
              ...
              {product.images.map((img, index) => (
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      e.target.src = 'https://via.placeholder.com/80x80/374151/9CA3AF?text=N/A';
                    }}
                  />
                </button>
              ))}
